...
| **Cognito User Pool** | `AWS::Cognito::UserPool` | `rag-user-pool` (o nombre asignado por stack) | Directorio de usuarios y emisor de ID Tokens |
| **Cognito App Client** | `AWS::Cognito::UserPoolClient` | `rag-app-client` | Cliente público usado por el frontend para autenticarse |
...
[ Microservicio Consulta (consulta/) ]
  └── Valida ID Token Cognito -> Recibe preguntas vía Function URL -> Búsqueda en Pinecone -> OpenRouter LLM -> DynamoDB
```
